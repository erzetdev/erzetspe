							...
							?>
									...
									<tr>
										...
										<td class="text-center col-2">
											<a href="<?= base_url('admin/lihat_nilai/') . $u->id; ?>" class="btn btn-primary">Lihat</a>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<a class="btn btn-primary" href="<?= base_url('admin/hapus_daftar_nilai/') . $u->id; ?>">Hapus</a>
												</div>
											</div>
										</div>
									</div>
...
<div class=" modal fade" id="modalTambahDaftarNilai" tabindex="-1" aria-labelledby="modalTambahDaftarNilaiLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="<?= base_url('admin/tambah_daftar_nilai'); ?>" method="POST">
