	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<!-- Card Body -->
				<div class="card-body">
					<table class="table table-bordered  table-responsive-md table-hover" id="dataTable" width="100%" cellspacing="0">
						<thead>
							<tr>
									...
									<tr>
										...
										<td>
											<div class="text-center">
												<div class="text-center">
													<a href="<?= base_url('admin/input_nilai/') . $daftar_nilai . '/' . $s->id; ?>" class="btn btn-sm btn-success">Input</a>
													<!-- <a href="<?= base_url('admin/hapus_siswa/') . $s->id; ?>" class="btn btn-sm btn-danger">Hapus</a> -->
												</div>
											</div>
										</td>
									</tr>
