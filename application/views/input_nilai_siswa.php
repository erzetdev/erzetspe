			...
			<div class="card shadow mb-4">
				<div class="card-body">
					<div class="text-right mb-3">
						<a href="<?= base_url('siswa/cetak_nilai/') . $daftar_nilai['id'] . '/' . $siswa['id']; ?>" class="btn btn-success">Cetak Nilai</a>
					</div>
					<!-- Editable table -->
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?= base_url('siswa/input_sikap/'); ?>" method="POST">
						<input type="hidden" value="<?= $siswa['id']; ?>" name="siswa" readonly>
						<input type="hidden" value="<?= $daftar_nilai['id']; ?>" name="daftar_nilai" readonly>
						<h6 class="mb-3 text-dark">1. Sikap Spiritual</h6>
						<div class="row">
							<div class="col-2">
								<div class="mb-3">
									<label class="form-label text-primary">Predikat</label>
									<select name="spiritual_predikat" class="form-control" required readonly>
										<option value="">...</option>
							...
							<div class="col-10">
								<div class="mb-3">
									...
									<textarea class="form-control" name="spiritual_des" rows="2" readonly><?= $sikap['spiritual_des']; ?></textarea>
								</div>
							</div>
						</div>
						<hr>
						...
						<div class="row">
							<div class="col-2">
								<div class="mb-3">
									<label class="form-label text-primary">Predikat</label>
									<select name="sosial_predikat" class="form-control" readonly required>
										<option value="">...</option>
							...
							<div class="col-10">
								<div class="mb-3">
									...
									<textarea class="form-control" name="sosial_des" rows="2" readonly><?= $sikap['sosial_des']; ?></textarea>
								</div>
							</div>
						</div>
					</form>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<!-- Card Body -->
				<form action="<?= base_url('siswa/simpan_pengetahuan/'); ?>" method="POST">
								...
								<tbody>
									...
									?>
											...
											<tr>
												...
												<td class="col-1"><input type="number" value="<?= $A['nilai']; ?>" name="nilai<?= $A['id']; ?>" class="form-control no-border" placeholder="" required readonly></td>
												<td class="col-1"><select name="predikat<?= $A['id']; ?>" class="form-control no-border" required readonly>
														<option value="">...</option>
												...
												<td class="col-6"><input type="text" value="<?= $A['deskripsi']; ?>" name="des<?= $A['id']; ?>" class="form-control no-border" readonly></td>
											</tr>
									<?php
								...
								<tbody>
									...
									?>
											...
											<tr>
												...
												<td class="col-1"><input type="number" value="<?= $B['nilai']; ?>" name="nilai<?= $B['id']; ?>" class="form-control no-border" placeholder="" required readonly></td>
												<td class="col-1"><select name="predikat<?= $B['id']; ?>" class="form-control no-border" required readonly>
														<option value="">...</option>
												...
												<td class="col-6"><input type="text" value="<?= $B['deskripsi']; ?>" name="des<?= $B['id']; ?>" class="form-control no-border" readonly></td>
											</tr>
									<?php
								...
								<tbody>
									...
									?>
											...
											<tr>
												...
												<td class="col-1"><input type="number" value="<?= $C['nilai']; ?>" name="nilai<?= $C['id']; ?>" class="form-control no-border" placeholder="" readonly required></td>
												<td class="col-1"><select name="predikat<?= $C['id']; ?>" class="form-control no-border" readonly required>
														<option value="">...</option>
												...
												<td class="col-6"><input type="text" value="<?= $C['deskripsi']; ?>" name="des<?= $C['id']; ?>" class="form-control no-border" readonly></td>
											</tr>
									<?php
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<!-- Card Body -->
				<form action="<?= base_url('siswa/simpan_ketrampilan/'); ?>" method="POST">
					<input type="hidden" value="<?= $siswa['id']; ?>" name="siswa">
					<input type="hidden" value="<?= $daftar_nilai['id']; ?>" name="daftar_nilai">
					<div class="card-body">
						<label class="mb-3 label">Kriteria Ketuntasan Minimal = 65</label>
								...
								<tbody>
									...
									?>
											...
											<tr>
												...
												<td class="col-4"><?= $A['mapel']; ?></td>
												<input type="hidden" value="<?= $A['id']; ?>" name="mapel<?= $A['id']; ?>">
												<td class="col-1"><input type="number" value="<?= $A['nilai']; ?>" name="nilai<?= $A['id']; ?>" class="form-control no-border" placeholder="" readonly required></td>
												<td class="col-1"><select name="predikat<?= $A['id']; ?>" class="form-control no-border" required readonly>
														<option value="">...</option>
														<option value="A" <?= set_select('predikat', 'A', (isset($A['predikat']) && $A['predikat'] == "A" ? TRUE : FALSE)); ?>>A</option>
														<option value="B" <?= set_select('predikat', 'B', (isset($A['predikat']) && $A['predikat']  == "B" ? TRUE : FALSE)); ?>>B</option>
								...
								<tbody>
									...
									?>
											...
											<tr>
												...
												<td class="col-4"><?= $C['mapel']; ?></td>
												<input type="hidden" value="<?= $C['id']; ?>" name="mapel<?= $C['id']; ?>">
												<td class="col-1"><input type="number" value="<?= $C['nilai']; ?>" name="nilai<?= $C['id']; ?>" class="form-control no-border" placeholder="" required readonly></td>
												<td class="col-1"><select name="predikat<?= $C['id']; ?>" class="form-control no-border" required readonly>
														<option value="">...</option>
														<option value="A" <?= set_select('predikat', 'A', (isset($C['predikat']) && $C['predikat'] == "A" ? TRUE : FALSE)); ?>>A</option>
														<option value="B" <?= set_select('predikat', 'B', (isset($C['predikat']) && $C['predikat']  == "B" ? TRUE : FALSE)); ?>>B</option>
														<option value="C" <?= set_select('predikat', 'C', (isset($C['predikat']) && $C['predikat']  == "C" ? TRUE : FALSE)); ?>>C</option>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<!-- Editable table -->
					<form action="<?= base_url('siswa/simpan_ekstrakulikuler'); ?>" method="POST">
						<div id="table" class="table-editable">
								...
								<tbody>
									...
									?>
											...
											<tr>
												...
												<input type="hidden" value="<?= $siswa['id']; ?>" name="siswa">
												<input type="hidden" value="<?= $daftar_nilai['id']; ?>" name="daftar_nilai">
												<td class="col-1"><select name="predikat<?= $k->id; ?>" class="form-control no-border" readonly required>
														<option value="">...</option>
												...
												<td class="col-6"><input type="text" value="<?= $k->deskripsi; ?>" name="deskripsi<?= $k->id; ?>" class="form-control no-border" readonly></td>
											</tr>
									<?php
		...
		<div class="collg-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body mb-3">
					...
					<form action="<?= base_url('siswa/simpan_prestasi'); ?>" method="POST">
						<!-- Editable table -->
						<div id="table" class="table-editable">
							<table class="table table-bordered table-responsive-md table-striped">
								<thead>
								...
								<tbody>
									...
									?>
											...
											<tr>
												...
												<input type="hidden" value="<?= $siswa['id']; ?>" name="siswa">
												<input type="hidden" value="<?= $daftar_nilai['id']; ?>" name="daftar_nilai">
												<td><input type="text" name="kegiatan<?= $p->id; ?>" class="form-control no-border" value="<?= $p->kegiatan; ?>" readonly></td>
												<td><input type="text" name="keterangan<?= $p->id; ?>" class="form-control no-border" value="<?= $p->keterangan; ?>" readonly></td>
											</tr>
									<?php
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?= base_url('siswa/simpan_ketidakhadiran/'); ?>" method="POST">
							...
							<table class="table table-bordered table-responsive-md">
								...
								<tbody>
									<tr>
										...
										<td class="text-center col-1"><input type="number" value="<?= $ketidakhadiran['sakit']; ?>" name="sakit" class="form-control" placeholder="" required readonly></td>
										<td class="col-5"> Hari</td>
									</tr>
									<tr>
										<td class="col-6">Izin</td>
										<td class="text-center col-1"><input type="number" value="<?= $ketidakhadiran['izin']; ?>" name="izin" class="form-control" placeholder="" required readonly></td>
										<td class="col-5"> Hari</td>
									</tr>
									<tr>
										<td class="col-6">Tanpa Keterangan</td>
										<td class="text-center col-1"><input type="number" value="<?= $ketidakhadiran['tanpa_keterangan']; ?>" name="tanpa_keterangan" class="form-control" placeholder="" required readonly></td>
										<td class="col-5"> Hari</td>
									</tr>
								</tbody>
							</table>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?= base_url('siswa/simpan_catatan_wali/'); ?>" method="POST">
						<input type="hidden" value="<?= $siswa['id']; ?>" name="siswa">
						<input type="hidden" value="<?= $daftar_nilai['id']; ?>" name="daftar_nilai">
						<input type="hidden" name="id" value="<?= $catatanWali['id']; ?>">
						<input type="hidden" name="wali" value="<?= $guru['id']; ?>">
						<div class="mb-3">
							<textarea class="form-control" name="catatan" rows="3" readonly><?= $catatanWali['catatan']; ?></textarea>
						</div>
					</form>
				</div>
			</div>
