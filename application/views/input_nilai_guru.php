			...
			<div class="card shadow mb-4">
				<div class="card-body">
					<div class="text-right mb-3">
						<a href="<?= base_url('guru/cetak_nilai/') . $daftar_nilai['id'] . '/' . $siswa['id']; ?>" class="btn btn-success">Cetak Nilai</a>
					</div>
					<!-- Editable table -->
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?= base_url('guru/input_sikap/'); ?>" method="POST">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<!-- Card Body -->
				<form action="<?= base_url('guru/simpan_pengetahuan/'); ?>" method="POST">
					<input type="hidden" value="<?= $siswa['id']; ?>" name="siswa">
					<input type="hidden" value="<?= $daftar_nilai['id']; ?>" name="daftar_nilai">
					<div class="card-body">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<!-- Card Body -->
				<form action="<?= base_url('guru/simpan_ketrampilan/'); ?>" method="POST">
					<input type="hidden" value="<?= $siswa['id']; ?>" name="siswa">
					<input type="hidden" value="<?= $daftar_nilai['id']; ?>" name="daftar_nilai">
					<div class="card-body">
						<label class="mb-3 label">Kriteria Ketuntasan Minimal = 65</label>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<!-- Editable table -->
					<form action="<?= base_url('guru/simpan_ekstrakulikuler'); ?>" method="POST">
						<div id="table" class="table-editable">
									...
									?>
											...
											<tr>
												...
												<td class="col-1 text-center">
													<a href="<?= base_url('guru/hapus_ekstrakulikuler/') . $k->id . '/' . $daftar_nilai['id'] . '/' . $siswa['id']; ?>" class="btn btn-danger">x</a>
												</td>
											</tr>
									<?php
		...
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					...
					<form action="<?= base_url('guru/simpan_prestasi'); ?>" method="POST">
						<!-- Editable table -->
						<div id="table" class="table-editable">
							<table class="table table-bordered table-responsive-md table-striped">
								<thead>
									...
									?>
											...
											<tr>
												...
												<td class="text-center">
													<a href="<?= base_url('guru/hapus_prestasi/') . $p->id . '/' . $daftar_nilai['id'] . '/' . $siswa['id']; ?>" class="btn btn-danger">x</a>
												</td>
											</tr>
									<?php
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?= base_url('guru/simpan_ketidakhadiran/'); ?>" method="POST">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?= base_url('guru/simpan_catatan_wali/'); ?>" method="POST">
						<input type="hidden" value="<?= $siswa['id']; ?>" name="siswa">
						<input type="hidden" value="<?= $daftar_nilai['id']; ?>" name="daftar_nilai">
